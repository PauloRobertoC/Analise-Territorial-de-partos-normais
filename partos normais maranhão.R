...
ma_2$partosnormaisCat<- cut(ma_2$Partosnormais, breaks = c(0, 30, 50, 70, 100), labels = c("0 a 30%", "30 a 50%", "50 a 70%", "70 a 100%"), include.lowest = TRUE)
# percentuais criados 
...
ggplot(ma.f, aes(ma.f$long, ma.f$lat, group = ma.f$group, fill = ma.f$partosnormaisCat)) + 
  ...
  scale_fill_manual(values = brewer.pal(9, "YlOrRd")[4:9])
